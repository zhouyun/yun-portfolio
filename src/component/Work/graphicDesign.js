      ...
      <div className="graphic-design">
      	<div className="side-bar">
	      	<Sidebar>
	      		...
	      		<div><Link to="#background">Background</Link></div>
	      		<div><Link to="#digital-rocks">The Challenge</Link></div>
	      		<div><Link to="#design-shape">Logic Comes the first</Link></div>
	      		<div><Link to="#great-time">Design comes the next</Link></div>
	      		<div><Link to="#to-be-continue">Into the details</Link></div>
	      		<div><Link to="#design-team-x">Design Shape</Link></div>
	      	</Sidebar>
	      </div>
